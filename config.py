...
CHANNEL_DB = int(os.environ.get("CHANNEL_DB", "-1002386728237"))
MONGO_URL = os.environ.get("MONGO_URL", "mongodb+srv://pan3:pan4@cluster0.d8ubn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

RESTRICT = strtobool(os.environ.get("RESTRICT", "True"))

FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001801760271"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "6333990556 7362040638 5070693733 5178772086").split())]
except ValueError:
